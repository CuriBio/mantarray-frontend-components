...
export default {
  ...
  watch: {
    enter_uuidbase57() {
      const invalid_text = TextValidation_UUIDBase57.validate(
  ...
  created: function () {
    ...
    this.error_text_uuid = "This field is required";
    this.error_text_api = "";
