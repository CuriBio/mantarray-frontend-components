  ...
  watch: {
    entrykey: function () {
      ...
      switch (this.heatmap_option) {
        ...
        case "Contraction Velocity": {
          this.upper = 250;
          this.lower = 0;
          this.range = [
            { color: "#2c7bb6", offset: "0%" },
            { color: "#F0A061", offset: "100%" },
          ];
          break;
        }
        case "Relaxation Velocity": {
          this.upper = 300;
          this.lower = 0;
          this.range = [
            { color: "#2c7bb6", offset: "0%" },
            { color: "#DF6147", offset: "100%" },
          ];
          break;
        }
        default: {
