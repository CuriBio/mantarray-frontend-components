...
const base_screenshot_path = path.join("plate_based", "plate-navigator");
...
fixture`plate_based/plate-navigator/basic`
  .page // declare the fixture
`http://localhost:8080/plate_based/plate-navigator/basic`; // specify the start page
...
fixture`plate_based/plate-navigator/x-y-offset`
  .page // declare the fixture
`http://localhost:8080/plate_based/plate-navigator/x-y-offset`; // specify the start page
