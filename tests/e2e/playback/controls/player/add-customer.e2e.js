...
fixture`playback/controls/player/settings-button/add-customer`
  .page // declare the fixture
`http://localhost:8080/playback/controls/player/settings-button/add-customer`; // specify the start page
...
test("testing for the add customer VALID State and CANCEL HOVER", async (t) => {
  ...
  const screenshot_path = path.join(
    screenshot_path_base,
    "add-customer-valid-Cancel-Hover"
  );
  await testcafe_page_visual_regression(t, screenshot_path);
});
