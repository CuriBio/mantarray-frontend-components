...
describe("PlateBarcode.vue", () => {
  ...
  test.each([
    ...
    ["ML2021$72144", "error due toinvalid character '$'", null],
    ["ML2020172144", "error due toinvalid year '2020'", null],
    ["ML2021000144", "error due toinvalid Julian date '000'", null],
    ["ML2021367144", "error due toinvalid Julian date '367'", null],
    ["ML2021172002", "error due toinvalid kit ID '002'", null],
    ["ML2021172003", "error due toinvalid kit ID '003'", null],
    ["ML2021172146", "error due toinvalid kit ID '146'", null],
    ["ML2021172147", "error due toinvalid kit ID '147'", null],
